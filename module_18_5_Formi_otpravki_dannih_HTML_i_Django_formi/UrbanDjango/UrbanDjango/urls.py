...
from task5.views import reg_post
...
urlpatterns = [
    ...
    path('platform/plat_shop/', TemplateView.as_view(template_name='fourth_task/plat_shop.html')),
    path('platform/plat_basket/', TemplateView.as_view(template_name='fourth_task/plat_basket.html')),
    path('registration_page/', reg_post),
]
